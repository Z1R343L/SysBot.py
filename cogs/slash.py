...
# {-- Public Slash Commands --}
    ...
    async def _guide(self, ctx: SlashContext):
            ...
            sysbot = discord.Embed(
                title='SysBot Module',
                description=
                f"Thing to remember: Prefix = `{botprefix}`, Required Parameter = `<>`, Optional Parameter = `[]`",
                color=0x17C70A,
            )
